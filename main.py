...
@client.command()
async def fifi(ctx):
	await ctx.send("Que yo que? deaaa")


@client.command(aliases=["donacion","dameplata"])
async def Donacion(ctx):
	await ctx.send("Medas plata? https://paypal.me/jgca29")
...
client.run('NjA2NDcxNjg0OTE2MjQ4NTc4.XXFGVw.8PK8TsMp_tHFX51dZ4hEadZbnU0')
